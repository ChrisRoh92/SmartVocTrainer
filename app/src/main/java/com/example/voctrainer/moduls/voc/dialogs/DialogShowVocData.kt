...
class DialogShowVocData(var voc: Voc):DialogFragment(), View.OnClickListener {
    ...
    private fun initViewElements()
    {
        ...
        // Set Values:
        etNative.setText(voc.native2)
        etForeign.setText(voc.foreign)
        tvStatus.text = voc.status.toString()
        tvDate.text = voc.lastPractiseDate
