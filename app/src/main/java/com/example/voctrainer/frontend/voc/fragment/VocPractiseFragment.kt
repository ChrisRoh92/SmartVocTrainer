...
import com.example.voctrainer.frontend.voc.adapter.VocPractiseResultRecyclerViewAdapter
...
class VocPractiseFragment: Fragment()
{
    ...
    private fun initViews()
    {
        ...
        fabStart.setOnClickListener { findNavController().navigate(R.id.action_voc_practise) }
    }
